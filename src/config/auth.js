...
module.exports = {
  ...
  sessionCreateMaxPerUser: toNumber(process.env.SESSION_CREATE_MAX_PER_USER, 3),
  sessionCreateMaxPerIp: toNumber(process.env.SESSION_CREATE_MAX_PER_IP, 5),
  sessionActiveCapRegistered: toNumber(process.env.SESSION_ACTIVE_CAP_REGISTERED, 3),
  sessionActiveCapGuest: toNumber(process.env.SESSION_ACTIVE_CAP_GUEST, 1),
